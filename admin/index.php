...
<main class="contenedor seccion">
    ...
    <?php if (intval($resultado) === 1) : ?> <!---CREADO CORRECTAMENTE-->
        <p class="alerta exito">Anuncio Creado Correctamente</p>
    <?php elseif (intval($resultado) === 2) : ?><!---ACTUALIZADO CORRECTAMENTE-->
        <p class="alerta exito">Anuncio Actualizado Correctamente</p>
    <?php elseif (intval($resultado) === 3) : ?><!---ELIMINADO CORRECTAMENTE-->
